    ...
    public class CameraBase : MonoBehaviour, ITouchCamera
    {
           ...
           bool instant = false)
        {
           ...
           " instant:" + instant, this);
            ...
            if (!enablePositionChange) focusMoveOffset.Completed = true;
            if (!enableDistanceChange) focusMoveDistanceOrSize.Completed = true;
            if (!enableRotationChange) focusMoveRotation.Completed = true;
        ...
        virtual public void FocusCameraOnGameObject(GameObject go, bool allowYOffsetFromGround = false)
        {
            ...
            this.isFocusing = this.focusTargetGo != null;
        ...
        public Vector3Spring focusMoveOffset;
        ...
        virtual protected void OnFocusCompleted()
        {
            bool distanceCompleted = !enableDistanceChange || focusMoveDistanceOrSize.Completed;
            bool rotationCompleted = !enableRotationChange || focusMoveRotation.Completed;
            bool moveCompleted = !enablePositionChange || focusMoveOffset.Completed;
