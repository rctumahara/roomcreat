...
Shader "InnuendoGameLabs/Standard/DiffNormSpec" {
    Properties {
...
////// Specular:
                ...
                float3 specularColor = (_SpecularTexture2D_var.rgb*clamp(_SpecularMultiplierClamped010,0.0,10.0));
...
/////// Diffuse:
                ...
                float3 diffuse = (directDiffuse + indirectDiffuse) * _DiffuseTexture2D_var.rgb;
/// Final Color:
...
/////// Diffuse:
                ...
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float4 _DiffuseTexture2D_var = tex2D(_DiffuseTexture2D,TRANSFORM_TEX(i.uv0, _DiffuseTexture2D));
                float3 diffuse = directDiffuse * _DiffuseTexture2D_var.rgb;
/// Final Color:
                float3 finalColor = diffuse + specular;
